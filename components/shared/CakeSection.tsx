      ...
      <div className="container mx-auto px-4 py-12 sm:py-16 lg:py-8 text-center">
        <div className="relative z-10">
         ...
         <br/> Deserves a Cake 
          ...
          {/* Updated button with more contrast */}
          <Button className="bg-yellow-400 hover:bg-yellow-300 text-blue-900 font-bold py-2 px-6 rounded-full transition-colors duration-300">
            Place your order today {String.fromCodePoint(0x1f973)}
          </Button>
        </div>

        <div className="relative mt-10 lg:mt-8">
          {/* Added smoother visual transition between sections */}
          ...
          <div className="relative z-10 flex justify-center items-end space-x-6">
            {/* Ensure consistent image sizing and spacing */}
            <Image
