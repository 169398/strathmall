                ...
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                  <FormLabel>
                    ...
                    <span className="text-xs">
                      ...
                      its Privacy Policy and that you may withdraw your consent
                      at any time.
                    </span>
                  </FormLabel>
                  <FormMessage />
        ...
        <Accordion>
          ...
          <AccordionDetails id="panel1-content">
            <span className="text-xs">
              ...
              sign-up and submit your shop details ,Pay the onboarding fee then
              You can start uploading your products immediately after creating
              your shop.
            </span>
          </AccordionDetails>
        </Accordion>
